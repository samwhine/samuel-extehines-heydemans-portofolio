...
export const metadata: Metadata = createMetadata({
  title: "About Samuel Extehines Heydemans — Video Editor & Creative Staff",
  description: "Learn about Samuel Extehines Heydemans, a short-form video editor and creative staff member specializing in Reels, TikTok, YouTube Shorts, music content, creative direction, and technical production.",
  path: "/about",
});
...
export default function AboutPage(): ReactNode {
  return (
    <main id="main-content" className="flex flex-1 flex-col">
      ...
      <section className="mx-auto w-full max-w-160 px-6 pt-20 pb-16 sm:px-10 sm:pt-28 sm:pb-24"><FadeIn delay={0.5}><div className="rounded-4xl border border-foreground/5 bg-foreground/1.5 p-8 sm:p-12 dark:bg-foreground/3"><h1 className="font-serif text-[1.75rem] font-medium tracking-tight text-foreground sm:text-[2rem]">Hello! I&rsquo;m <span className="border-b border-foreground/30 pb-0.5">Samuel Extehines Heydemans</span>.</h1><div className="mt-8 space-y-6 text-[17px] leading-[1.7] tracking-tight text-foreground/75 sm:text-[18px]"><p>I&rsquo;m Samuel, a <strong className="font-semibold text-foreground">Creative Staff and Video Editor</strong> working in the music industry. My main focus day-to-day is <strong className="font-semibold text-foreground">short-form editing for Reels, Shorts, and TikTok</strong>, on top of managing YouTube channels, editing promotional content for artists, and helping shape creative direction for talent under a record label. I also manage <strong className="font-semibold text-foreground">the office&rsquo;s self-hosted servers and Cloudflare Tunnel infrastructure</strong> — I even built a custom dashboard to keep it all under control from one place.</p><p>Outside of work, I serve as a <strong className="font-semibold text-foreground">Music Director</strong> at GMS Kelapa Gading — arranging worship music and playing keyboard, bass, and drums (mostly by ear, big love for jazz).</p><p>Currently studying <strong className="font-semibold text-foreground">Informatics Engineering</strong> at Universitas Mercu Buana while working full-time in the creative field.</p></div></div></FadeIn></section>
